 ...
 */
package com.zhanglin.commonlib.base.api;

import com.google.gson.reflect.TypeToken;
import com.zhanglin.commonlib.base.entity.ResultEntity;
            ...
            call.enqueue(new Callback<T>() {
                ...
                public void onFailure(Call<T> call, Throwable t) {
                    ...
                    if (!subscriber.isUnsubscribed() && t != null) {
                        if (t.getMessage() != null && (t.getMessage().contains("JsonSyntaxException")||t.getMessage().contains("MalformedJsonException"))) {
                            ...
                            try {
                                if (response.isSuccessful()) {
                                    if (response.body() instanceof ResultEntity) {
                                        ResultEntity result = (ResultEntity) response.body();
                                        if (result != null) {
...
//                                RxBus.getDefault().post(new EventTokenExpires(response.code(), errorMsg));
                        ...
                        private Observable<R> handleError(ResultEntity result) {
                            String errorMsg;
